...
import br.edu.ifsuldeminas.mach.apppomodoro.utils.LocalAuthManager;
                ...
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        String error = task.getException() != null ? 
                                task.getException().getMessage() : "Erro desconhecido";
                        Log.e(TAG, "Erro no login: " + error);
                        Toast.makeText(this, "Erro ao fazer login: " + error, Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(e -> {
                    buttonLogin.setEnabled(true);
                    buttonLogin.setText("Entrar");
                    Log.e(TAG, "Falha no login: " + e.getMessage());
